...
\DeclareGraphicsExtensions{.pdf,.png,.jpg,.svg}
 ...
 \shortTitle{Algorytmy}
	 ...
	 \section{Filtrowanie z analizą zawartości}
		 ...
		 Na potrzeby algorytmu rekomendacji zdecydowano się przyjąć sigmoidalną funkcję aktywacji neuronu (równanie \ref{eq:sigmoidal}). Funkcja przyjmuje wartości z zakresu $[0,1]$.
		 ...
		 \subsubsection{Propagacja wsteczna}
			...
			\end{figure}
			 ...
			 \cite{hertz1993wstkep}\cite{timothy1996sieci}
