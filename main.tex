...
\DeclareGraphicsExtensions{.pdf,.png,.jpg,.svg}
 ...
 \todo{(PYTANIE) Czy to dobry pomysł żeby ten rozdział zacząć w taki sposób? A niżej już wymienić metody, algorytmy etc.}
 ...
 \shortTitle{Algorytmy}
	...
	W tym celu dla każdego użytkownika tworzona jest sieć neuronowa, która uczy się jego preferencji. W projekcie wykorzystana została implementacja sieci neuronowych z biblioteki AForge.NET Framework \cite{aforgenet}.
	 ...
	 \section{Algorytymy hybrydowe}
		 ...
		 Zaimplementowanych zostało 9 wariantów:
...
\begin{figure}[!ht]
	\centering
	\includegraphics[page=2,width=1\textwidth]{exphybrid1amazon1}
