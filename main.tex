 ...
 \shortTitle{Algorytmy}
	...
	\todo{Napisać wstęp. Co powinien zawierać?}
	 ...
	 \section{Filtrowanie kolaboratywne}
		 ...
		 Najefektywniejsze okazały się algorytmy SVD++, Biased Matrix Factorization i Matrix Factorization bazujące na podejściu w oparciu o model. \todo{Wymienic algorytmy z wykresu i coś o nich napisać}
