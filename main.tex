...
\todo{napisać dlaczego wybrałam matrix factorization a nie inne sposoby}

	 \section{Filtrowanie kolaboratywne -- faktoryzacja macierzy}
	 
		 Jednym ze sposobów na przeprowadzenie filtrowania kolaboratywnego jest rozkład macierzy na czynniki (eng. matrix factorization). 
